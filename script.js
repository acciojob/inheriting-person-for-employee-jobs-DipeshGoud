...
function Employee(name, age, jobTitle) {
  // Call the parent constructor (Person) with the given arguments
...
// Set the correct constructor for Employee (otherwise it would be Person)
Employee.prototype.constructor = Employee;

// Method to greet an employee with their job title
